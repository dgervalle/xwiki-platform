...
/**
 * Migration for XWIKI4396: Duplicate document ID. This data migration change document ID to use the new improved hash
 * algorithm.
 *
 * @version $Id$
 */
@Component
@Named("R31999XWIKI4396")
public class R31999XWIKI6990DataMigration extends AbstractHibernateDataMigration
{
    @Override
    ...
    {
        return new XWikiDBVersion(31999);
    }
