...
/**
 * Migration for XWIKI4396: Duplicate document ID. This migrator change document ID to use the new improved hash
 * algorithm.
 *
 * @version $Id$
 */
    ...
    public void hibernateMigrate() throws DataMigrationException, XWikiException
    {
        ...
        getStore().executeWrite(getXWikiContext(), true, new XWikiHibernateBaseStore.HibernateCallback<Object>()
        {
            ...
            public Object doInHibernate(Session session) throws HibernateException, XWikiException
            {
                ...
                try {
                    session
                        .createQuery("update " + docClass + " doc set doc.translation = 0 where doc.translation is null")
                        .executeUpdate();
                    ...
                    session
                        .createQuery("delete from " + BaseProperty.class.getName() +
                            " prop where prop.name like 'editbox_%' and prop.classType = 'com.xpn.xwiki.objects.LongProperty'")
                        .executeUpdate();

                    session
                        .createQuery("delete from " + LongProperty.class.getName() + " prop where prop.name like 'editbox_%'")
                        .executeUpdate();
                } catch (Exception e) {
